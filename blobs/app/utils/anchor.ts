...
import { Blobs, IDL } from "../idl/blobs"
...
// Blobs game program ID
const programId = new PublicKey("9aMxRDFLQwW2e185TdpfHJWAWTGhzLQwB7SuEf58WYDX")

// Create the program interface using the idl, program ID, and provider
export const program = new Program<Blobs>(IDL, programId, {
...
export type PlayerData = IdlAccounts<Blobs>["playerData"]
export type GameData = IdlAccounts<Blobs>["gameData"]
